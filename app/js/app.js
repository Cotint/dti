...
$(document).ready(function(e) {
    ...
    $("#aboutnav").click(function(e) {
        z = $("#about").offset();
        $("body,html").animate({scrollTop:z.top},1000);
    });
    $("#customernav").click(function(e) {
       x = $("#costomers").offset();
        $("body,html").animate({scrollTop:x.top},1000);
    });
    $("#productsnav").click(function(e) {
        s = $("#portfolio").offset();
        $("body,html").animate({scrollTop:s.top},1000);
    });

    $("#servicenav").click(function(e) {
        v = $("#service").offset();
        $("body,html").animate({scrollTop:v.top},1000);
    });
    $("#latestnav").click(function(e) {
        h = $("#latest").offset();
        $("body,html").animate({scrollTop:h.top},1000);
    });
    $("#contactnav").click(function(e) {
        w = $("#contact").offset();
        $("body,html").animate({scrollTop:w.top},1000);
    });
});
...
$(document).ready(function () {
    ...
    $('#bottomslider').owlCarousel({
        ...
        margin: 0,
        nav: true,
        navText: ["<i class='fa fa-long-arrow-right prev'></i>", "<i class='fa fa-long-arrow-left next'></i>"],
        responsive: {
            0: {
                items: 1
            },
