...
<main id="about" class="container">
    ...
    <p class="text-center"><img class="code" src="<?php bloginfo ('template_directory');?>/app/images/dti-code.jpg" alt="code"></p>
    <section class="container">
...
<p class="text-center"><img class="image" src="<?php bloginfo ('template_directory');?>/app/images/dti-code.jpg" alt="code"></p>
<section class="container">
